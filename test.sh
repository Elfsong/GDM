...
# python eval_run.py --model-type BaseAgent --model-name deepseek-ai/deepseek-llm-7b-chat
...
# BAAIAgent
python eval_run.py --model-type BaseAgent --model-name BAAI/AquilaChat-7B
python eval_run.py --model-type BaseAgent --model-name BAAI/AquilaChat-7B
python eval_run.py --model-type BaseAgent --model-name BAAI/Emu3-Chat
...
python eval_run.py --model-type BaseAgent --model-name THUDM/glm-4-9b-chat-1m
